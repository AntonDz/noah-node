...
import (
	...
	"github.com/noah-blockchain/noah-node/types/time"
...
func makeHeaderPartsResponsesValPubKeyChange(state State, pubkey crypto.PubKey) (types.Header, types.BlockID, *ABCIResponses) {
	...
	if !bytes.Equal(pubkey.Bytes(), val.PubKey.Bytes()) {
		abciResponses.EndBlock = &types2.ResponseEndBlock{
			ValidatorUpdates: []types2.ValidatorUpdate{
...
func makeHeaderPartsResponsesParams(state State, params types.ConsensusParams) (types.Header, types.BlockID, *ABCIResponses) {
	...
	block := makeBlock(state, state.LastBlockHeight+1)
	abciResponses := &ABCIResponses{
		EndBlock: &types2.ResponseEndBlock{ConsensusParamUpdates: types.TM2PB.ConsensusParams(&params)},
	}
	return block.Header, types.BlockID{Hash: block.Hash(), PartsHeader: types.PartSetHeader{}}, abciResponses
}
...
type testApp struct {
	...
	CommitVotes         []types2.VoteInfo
	ByzantineValidators []types2.Evidence
	ValidatorUpdates    []types2.ValidatorUpdate
}

var _ types2.Application = (*testApp)(nil)

func (app *testApp) Info(req types2.RequestInfo) (resInfo types2.ResponseInfo) {
	return types2.ResponseInfo{}
}

func (app *testApp) BeginBlock(req types2.RequestBeginBlock) types2.ResponseBeginBlock {
	app.CommitVotes = req.LastCommitInfo.Votes
	app.ByzantineValidators = req.ByzantineValidators
	return types2.ResponseBeginBlock{}
}

func (app *testApp) EndBlock(req types2.RequestEndBlock) types2.ResponseEndBlock {
	return types2.ResponseEndBlock{ValidatorUpdates: app.ValidatorUpdates}
}

func (app *testApp) DeliverTx(req types2.RequestDeliverTx) types2.ResponseDeliverTx {
	return types2.ResponseDeliverTx{Events: []types2.Event{}}
}

func (app *testApp) CheckTx(req types2.RequestCheckTx) types2.ResponseCheckTx {
	return types2.ResponseCheckTx{}
}

func (app *testApp) Commit() types2.ResponseCommit {
	return types2.ResponseCommit{}
}

func (app *testApp) Query(reqQuery types2.RequestQuery) (resQuery types2.ResponseQuery) {
	return
}

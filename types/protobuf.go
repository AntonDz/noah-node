...
func (tm2pb) PartSetHeader(header PartSetHeader) types.PartSetHeader {
...
func (tm2pb) ValidatorUpdate(val *Validator) types.ValidatorUpdate {
...
// XXX: panics on nil or unknown pubkey type
func (tm2pb) ValidatorUpdates(vals *ValidatorSet) []types.ValidatorUpdate {
	validators := make([]types.ValidatorUpdate, vals.Size())
...
// XXX: panics on nil or unknown pubkey type
func (tm2pb) Evidence(ev Evidence, valSet *ValidatorSet, evTime time.Time) types.Evidence {
...
// XXX: panics on nil or unknown pubkey type
func (tm2pb) NewValidatorUpdate(pubkey crypto.PubKey, power int64) types.ValidatorUpdate {
...
func (pb2tm) ValidatorUpdates(vals []types.ValidatorUpdate) ([]*Validator, error) {

...
import (
	...
	mock2 "github.com/noah-blockchain/noah-node/mock"
...
func TestApplyBlock(t *testing.T) {
	...
	blockExec := NewBlockExecutor(stateDB, log.TestingLogger(), proxyApp.Consensus(),
		mock2.Mempool{}, MockEvidencePool{})
...
func TestBeginBlockByzantineValidators(t *testing.T) {
	...
	testCases := []struct {
		...
		expectedByzantineValidators []types2.Evidence
	}{
		{"none byzantine", []types.Evidence{}, []types2.Evidence{}},
		{"one byzantine", []types.Evidence{ev1}, []types2.Evidence{types.TM2PB.Evidence(ev1, valSet, now)}},
		{"multiple byzantine", []types.Evidence{ev1, ev2}, []types2.Evidence{
...
func TestValidateValidatorUpdates(t *testing.T) {
	...
	testCases := []struct {
		...
		abciUpdates     []types2.ValidatorUpdate
	...
	}{
		{
			...
			[]types2.ValidatorUpdate{{PubKey: types.TM2PB.PubKey(pubkey2), Power: 20}},
		...
		},
		{
			...
			[]types2.ValidatorUpdate{{PubKey: types.TM2PB.PubKey(pubkey1), Power: 20}},
			defaultValidatorParams,
		...
		},
		{
			...
			[]types2.ValidatorUpdate{{PubKey: types.TM2PB.PubKey(pubkey2), Power: 0}},
			defaultValidatorParams,
		...
		},
		{
			...
			[]types2.ValidatorUpdate{{PubKey: types.TM2PB.PubKey(pubkey2), Power: -100}},
			defaultValidatorParams,
		...
		},
		{
			...
			[]types2.ValidatorUpdate{{PubKey: types.TM2PB.PubKey(secpKey), Power: -100}},
			defaultValidatorParams,
...
func TestEndBlockValidatorUpdates(t *testing.T) {
	...
	blockExec := NewBlockExecutor(stateDB, log.TestingLogger(), proxyApp.Consensus(), mock2.Mempool{}, MockEvidencePool{})
	...
	app.ValidatorUpdates = []types2.ValidatorUpdate{

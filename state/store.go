...
type ABCIResponses struct {
	DeliverTx  []*types2.ResponseDeliverTx `json:"deliver_tx"`
	EndBlock   *types2.ResponseEndBlock    `json:"end_block"`
	BeginBlock *types2.ResponseBeginBlock  `json:"begin_block"`
}

// NewABCIResponses returns a new ABCIResponses
func NewABCIResponses(block *types.Block) *ABCIResponses {
	resDeliverTxs := make([]*types2.ResponseDeliverTx, block.NumTxs)
	if block.NumTxs == 0 {

...
import (
	...
	client3 "github.com/noah-blockchain/noah-node/lite/client"
	"os"
	"testing"
	"time"
	...
	nm "github.com/noah-blockchain/noah-node/node"
...
func _TestAppProofs(t *testing.T) {
	...
	source := client3.NewProvider(chainID, cl)
	seed, err := source.LatestFullCommit(chainID, 1, 1)
	require.NoError(err, "%#v", err)
	cert := lite2.NewBaseVerifier(chainID, seed.Height(), seed.Validators)

...
func TestTxIndex(t *testing.T) {
	...
	txResult := &types.TxResult{
		...
		Index:  0,
		Tx:     tx,
		Result: types2.ResponseDeliverTx{
			Data: []byte{0},
			Code: types2.CodeTypeOK, Log: "", Events: nil,
		},
	}
	hash := tx.Hash()
...
func TestTxSearch(t *testing.T) {
	...
	txResult := txResultWithEvents([]types2.Event{
...
func TestTxSearchDeprecatedIndexing(t *testing.T) {
	...
	txResult1 := txResultWithEvents([]types2.Event{
		{Type: "account", Attributes: []cmn.KVPair{{Key: []byte("number"), Value: []byte("1")}}},
	})
...
func TestTxSearchMultipleTxs(t *testing.T) {
	...
	txResult2 := txResultWithEvents([]types2.Event{
		{Type: "account", Attributes: []cmn.KVPair{{Key: []byte("number"), Value: []byte("2")}}},
	})
	...
	txResult3 := txResultWithEvents([]types2.Event{
	...
	txResult4 := txResultWithEvents([]types2.Event{
...
func txResultWithEvents(events []types2.Event) *types.TxResult {
	tx := types.Tx("HELLO WORLD")

...
func InitChain(client client.Client) error {
	total := 10
...
func SetOption(client client.Client, key, value string) error {
...
func Commit(client client.Client, hashExp []byte) error {
...
func DeliverTx(client client.Client, txBytes []byte, codeExp uint32, dataExp []byte) error {
...
func CheckTx(client client.Client, txBytes []byte, codeExp uint32, dataExp []byte) error {
